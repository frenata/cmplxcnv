...
var cmplx = []complex128{0i, 011i, 0.i, 2.71828, 1E6i, 1.e+0i, 0, 3.0 + 2i, 2.7e-4 + 2i, 7.7e+4 + 0.9i, 3i + 4.0, 2.1i + 4.55e+10, 0}
...
// TODO: tests for complex to string, tests for expected errors
